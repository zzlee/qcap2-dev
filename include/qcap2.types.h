...
enum qcap2_video_sink_backend_type_t {
	...
	QCAP2_VIDEO_SINK_BACKEND_TYPE_DRM,
...
enum qcap2_video_encoder_backend_type_t {
	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_UNKNOWN,

	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_DEFAULT,
	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_ALLEGRO,
	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_ALLEGRO2,
	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_V4L2_M2M,

	QCAP2_VIDEO_ENCODER_BACKEND_TYPE_EXPERIMENTAL = 9999,
};

enum qcap2_video_decoder_backend_type_t {
	QCAP2_VIDEO_DECODER_BACKEND_TYPE_UNKNOWN,

	QCAP2_VIDEO_DECODER_BACKEND_TYPE_DEFAULT,
	QCAP2_VIDEO_DECODER_BACKEND_TYPE_ALLEGRO,
	QCAP2_VIDEO_DECODER_BACKEND_TYPE_ALLEGRO2,
	QCAP2_VIDEO_DECODER_BACKEND_TYPE_V4L2_M2M,

	QCAP2_VIDEO_DECODER_BACKEND_TYPE_EXPERIMENTAL = 9999,
};
